...
public class StockAccount extends CompanyShares implements CustomerAccountData {
    ...
    */
    ...
    {
        // Add stock name
        ArrayList <String> temp_stock_symbol_arr = super.getStock_symbol();
        temp_stock_symbol_arr.add(stock_name);
        super.setStock_symbol(temp_stock_symbol_arr);
    ...
    */
    ...
    {   int indx = -1;
        ...
        if (indx==-1){
            ...
            super.setStock_symbol(String.valueOf(( super.getStock_symbol().add(symbol))));
        }
